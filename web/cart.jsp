                        ...
                        <div class="row">
                            <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                                ...
                                <div class="table-responsive">
                                    <h4>${requestScope.CHECKOUT_ERROR}</h4>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <form action="MainController" method="POST">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">                                                                       
                                                    <input type="number" name="NewQuantity" value="<%= cart.getCart().get(i).getQuantity()%>" min="1" require="" />kg
                                                    <input type="hidden" name="OldQuantity" value="<%= cart.getCart().get(i).getQuantity()%>"/>
                                                    <input type="hidden" name="ProductID" value="<%= cart.getCart().get(i).getID()%>"/>
                                                    <input type="hidden" name="ProductPrice" value="<%=(float) cart.getCart().get(i).getPrice() / cart.getCart().get(i).getQuantity()%>"/>
                                                </td>
                                                <td class="align-middle"><a href="#" class="text-dark">
                                                        <button type="submit" name="action" value="Edit" class="btn btn-danger">Edit</button>
                                                    </a>
                                                </td>
                                                <td class="align-middle"><a href="#" class="text-dark">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    <form action="MainController" method="POST">
                                        <button type="submit" class="btn btn-dark rounded-pill py-2 btn-block" style="color:white;" name="action" value ="CheckOut">CONFIRM AND CHECK OUT</button>
                                    </form>
