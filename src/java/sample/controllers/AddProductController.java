...
public class AddProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (productDao.getProduct(productName)) {
            ...
            if(check){
                boolean checkAdd=productDao.addProduct(productName, productImage, productPrice, productQuantity, productCategory, importDateS, usingDateS);
                if(checkAdd){
                    url=SUCCESS;
                    request.setAttribute("ADD_SUCCESS", "New product has been added");
                }else{
                    productError.setErrorMessage("Error while adding new product");
                }
            }else{
                productError.setErrorMessage("Error while adding new product");                   
            }
            ...
            log("Errot at AddProductController : " + e.toString());
        } finally {
