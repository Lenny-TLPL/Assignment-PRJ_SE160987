...
public class MainController extends HttpServlet {
    ...
    private static final String DEFAULT_PAGE_US = "home.jsp";
    private static final String DEFAULT_PAGE_AD = "admin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action==null){
                ...
                ArrayList<ProductDTO> ProductList = ProductDao.getListProduct();
